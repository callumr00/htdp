...
(define OBJECT1 (rectangle 10 10 "solid" "black"))
(define OBJECT2 (rectangle 10 10 "solid" "red"))
...
(define (render ws)
  (cond
    [(odd? ws) (place-image OBJECT1 (modulo ws SCENE-WIDTH) OBJECT-Y SCENE)]
    [else (place-image OBJECT2 (modulo ws SCENE-WIDTH) OBJECT-Y SCENE)]))
